...
from fairseq.modules import ParametericMish, gelu, gelu_accurate, TLU
...
def get_activation_fn(activation: str, *args, **kwargs) -> Callable:
    ...
    if activation == "relu":
        ...
        return ParametericMish(*args, **kwargs)
    elif activation == 'tlu':
        return TLU(*args, **kwargs)
    else:
